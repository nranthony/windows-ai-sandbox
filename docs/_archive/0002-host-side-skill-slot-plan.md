Restored 2026-08-25 from git history (deleted in 151cebf); closed without implementation, see work/README.md.
...
[ADR-0001](../adr/0001-provenance-tiers.md), and **not part of the dependency
guardrails thread** ([`work/0001`](dependency-guardrails-plan.md)).
